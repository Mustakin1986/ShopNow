    ...
    <div class="sl-logo"><a href="{{ url('admin/home') }}"><i class="icon ion-android-star-outline"></i> starlight</a></div>
        ...
        <div class="sl-sideleft-menu">
            ...
            <div class="sl-menu-item">
              ...
              <a href="{{ url('/') }}" target="_black" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
               ...
               <a href="#" class="sl-menu-link">
                ...
                <li class="nav-item"><a href="{{ route('admin.index') }}" class="nav-link">Add Category</a></li>
                <li class="nav-item"><a href="page-signin.html" class="nav-link">All Category</a></li>
                </ul>
